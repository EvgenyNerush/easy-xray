[Streisand in App Store](https://apps.apple.com/us/app/streisand/id6450534064).
...
![](figs/streisand-1.png)

To add customgeo rules for direct access, first press "+" (in right-up corner) and paste url-link with streisand app configuration:
