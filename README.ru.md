...
![схема: трафик до зарубежных сайтов идёт через сервер, а до домашних сайтов - напрямую с ПК](docs/figs/xray-schematic.png)
...
доступа напрямую, а IPv6-адрес использовался для доступа через сеть CDN от Cloudflare. Смотрите [полную инструкцию](docs/CDN.ru.md).
...
![прокси в браузере: http/https прокси 127.0.0.1 порт 801, socks5 хост 127.0.0.1 порт 800](docs/figs/browser-proxy-settings.png)
...
[v2rayN](docs/V2RayN.ru.md)

[v2rayA](docs/V2RayA.ru.md)

[nekoray](docs/Nekoray.ru.md).
...
Детальные инструкции для v2rayA можно найти [здесь](docs/V2RayA.ru.md).
...
Приложения, которые были протестированы, перечислены ниже.
  ...
  - [v2RayTun](https://play.google.com/store/apps/details?id=com.v2raytun.android&hl=ru) (инструкции: [RU](docs/v2RayTun.ru.md), [EN](docs/v2RayTun.md)),
  - [V2RayNG](https://play.google.com/store/apps/details?id=com.v2ray.ang&pcampaignid=web_share) (инструкции: [RU](docs/V2RayNG.ru.md)),
  - [HiddifyNG](https://play.google.com/store/apps/details?id=ang.hiddify.com&pcampaignid=web_share) (инструкции: [EN](docs/HiddifyNG.en.md)),
  - [Hiddify Next](https://play.google.com/store/apps/details?id=app.hiddify.com&pcampaignid=web_share).

Можно также использовать любое другое приложение, чья конфигурация аналогична упомянутым.

#### iOS

Используйте
  - [v2RayTun](https://play.google.com/store/apps/details?id=com.v2raytun.android&hl=ru) (инструкции: [RU](docs/v2RayTun.ru.md), [EN](docs/v2RayTun.md))
  - или [Streisand](https://apps.apple.com/us/app/streisand/id6450534064) (инструкции: [RU](docs/Streisand.ru.md), [EN](docs/Streisand.ru.md)).
  
Конфигурация аналогична тому, что описано для V2Ray или Hiddify.

#### OpenWRT

Используйте *v2rayA*. Инструкция [здесь](docs/V2RayA.ru.md).
