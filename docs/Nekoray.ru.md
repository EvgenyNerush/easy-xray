...
завершения nekoray в трее интернет пропадает, завершите nekoray через диспетчер задач, а также посмотрите, не сбились ли настройки
системного прокси (через Панель задач).
